...
shortDescription: "A diffusion-based terrain system that generates production-ready heightmaps and renders them in real time with a custom C++ OpenGL engine."
publishedAt: 2024-08-16
status: completed
categories: [graphics, procedural]
tier: 1
order: 7
